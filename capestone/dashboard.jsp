...
<div class="split left" style="width: 100%;">
	...
	<button class="btns">Check inventory</button><br>
	<button class="btns">Add category</button>
	<button class="btns">Add items</button><br>
	<button class="btns">Remove items</button>
	<button class="btns">Order items</button><br>
	<button class="btns">Damaged items</button>
	<button class="btns">View reports</button><br>
...
<div class="split right">
	<h3 align="center"><b> Notifications </b></h3>
	<hr>	
	<div class="right-div">
		<ul>
    <li>text</li>
